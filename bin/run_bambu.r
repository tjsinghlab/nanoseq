...
se     <- bambu(reads = readlist, annotations = grlist, genome = genomeSequence, ncore = ncore, verbose = TRUE, low_memory = TRUE, DISCOVERY = False, QUANTIFICATION = TRUE, OUTPUT = TRUE, OUTPUT_DIR = output_tag)
